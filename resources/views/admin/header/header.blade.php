        ...
        <div class="right-menu list-inline no-margin-bottom">
            <div class="list-inline-item">
                <a href="#" class="search-open nav-link">
                    <i class="icon-magnifying-glass-browser">
                    </i>
                </a>
            </div>
                ...
                <div aria-labelledby="navbarDropdownMenuLink2" class="dropdown-menu tasks-list">
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="progress">
                            ...
                            aria-valuemax="100" class="progress-bar dashbg-1">
                            </div>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="progress">
                            ...
                            aria-valuemax="100" class="progress-bar dashbg-3">
                            </div>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="progress">
                            ...
                            aria-valuemax="100" class="progress-bar dashbg-2">
                            </div>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="progress">
                            ...
                            aria-valuemax="100" class="progress-bar dashbg-4">
                            </div>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item">
            ...
            <div class="list-inline-item dropdown">
                ...
                aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle">
                    <img src="{{ asset('adminassets/img/flags/16/GB.png') }}" alt="English">
