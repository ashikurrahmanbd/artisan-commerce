            ...
            <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                    <div class="progress-details d-flex align-items-end justify-content-between">
                        <div class="title">
                            <div class="icon">
                                <i class="icon-writing-whiteboard">
                                </i>
                            </div>
                            <strong>
                                All Projects
            ...
            <div class="col-lg-6">
                ...
                <div class="stats-3-block block d-flex">
                    <div class="stats-3">
                        ...
                        <div class="progress progress-template progress-small">
                            <div role="progressbar" style="width: 35%;" aria-valuenow="30" aria-valuemin="0"
                            aria-valuemax="100" class="progress-bar progress-bar-template progress-bar-small dashbg-1">
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="user-block block text-center">
                    <div class="avatar">
                        <img src="{{ asset('adminassets/img/avatar-1.jpg') }}" alt="..." class="img-fluid">
                        <div class="order dashbg-2">
                            1st
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="user-block block text-center">
                    <div class="avatar">
                        <img src="{{ asset('adminassets/img/avatar-4.jpg') }}" alt="..." class="img-fluid">
            ...
            <div class="col-lg-4">
                <div class="user-block block text-center">
                    <div class="avatar">
                        <img src="{{ asset('adminassets/img/avatar-6.jpg') }}" alt="..." class="img-fluid">
                        <div class="order dashbg-4">
                            3rd
                        </div>
                    </div>
                    <a href="#" class="user-title">
        ...
        <div class="public-user-block block">
            <div class="row d-flex align-items-center">
                <div class="col-lg-4 d-flex align-items-center">
                    ...
                    <div class="avatar">
                        <img src="adminassets/img/avatar-2.jpg" alt="..." class="img-fluid">
                    </div>
                    <a href="#" class="name">
                        <strong class="d-block">
                            Alexander Shelby
        ...
        <div class="public-user-block block">
            <div class="row d-flex align-items-center">
                <div class="col-lg-4 d-flex align-items-center">
                    ...
                    <div class="avatar">
                        <img src="adminassets/img/avatar-6.jpg" alt="..." class="img-fluid">
                    </div>
                    <a href="#" class="name">
                        <strong class="d-block">
                            Arther Kooper
                ...
                <div class="messages-block block">
                    ...
                    <div class="messages">
                        <a href="#" class="message d-flex align-items-center">
                            <div class="profile">
                                <img src="{{ asset('adminassets/img/avatar-3.jpg') }}" alt="..." class="img-fluid">
                        ...
                        <a href="#" class="message d-flex align-items-center">
                            <div class="profile">
                                <img src="{{ asset('adminassets/img/avatar-2.jpg') }}" alt="..." class="img-fluid">
                        ...
                        <a href="#" class="message d-flex align-items-center">
                            <div class="profile">
                                <img src="{{ asset('adminassets/img/avatar-5.jpg') }}" alt="..." class="img-fluid">
